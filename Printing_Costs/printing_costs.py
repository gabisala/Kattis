...
# Amount of toner needed for every character printing
amount_toner = {
...
for text in data:
    ...
    # Remove whitespace because white requires no toner
    text = text.replace(' ', '')
    
    # Count letters in text
    count_letters = collections.Counter(text)
    total = 0

    # Search value for character and add to total
    for k, v in count_letters.iteritems():
        total += amount_toner[k] * v
